...
const congruencialMixto = (seed, k, a, c, m, i, tabla) => {
	...
	if (i < n - 1) {
		return congruencialMixto(nuevaSemilla, k, a, c, m, i + 1, tabla)
	} else {
		return tabla
	}
}

const congruencialMulti = (seed, a, m, k, i, tabla) => {
	...
	if (i < n - 1) {
		return congruencialMulti(nuevaSemilla, a, m, k, i + 1, tabla)
	} else {
		return tabla
	}
}
